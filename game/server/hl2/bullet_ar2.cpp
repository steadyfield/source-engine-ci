...
extern ConVar sk_plr_dmg_bullet_9mm;
extern ConVar sk_npc_dmg_bullet_9mm;
...
/*
IMPLEMENT_SERVERCLASS_ST( CBulletAR2, DT_BulletAR2 )
END_SEND_TABLE()
*/

CBulletAR2 *CBulletAR2::BulletCreate( const Vector &vecOrigin, const QAngle &angAngles, CBasePlayer *pentOwner )
{
	// Create a new entity with CBulletAR2 private data
	CBulletAR2 *pBullet = (CBulletAR2 *)CreateEntityByName( "bullet_ar2" );
...
//-----------------------------------------------------------------------------
bool CBulletAR2::CreateVPhysics( void )
{
...
//-----------------------------------------------------------------------------
//-----------------------------------------------------------------------------
unsigned int CBulletAR2::PhysicsSolidMaskForEntity() const
{
...
// Output : Returns true on success, false on failure.
//-----------------------------------------------------------------------------
bool CBulletAR2::CreateSprites( void )
{
...
void CBulletAR2::Spawn( void )
{
	...
	SetTouch( &CBulletAR2::BulletTouch );

	SetThink( &CBulletAR2::BulletThink );
...
// Input  : *pOther - 
//-----------------------------------------------------------------------------
void CBulletAR2::BulletTouch( CBaseEntity *pOther )
{
	/*
	...
	*/
	...
	else
	{
		...
		{
			SetThink( &CBulletAR2::SUB_Remove );
...
// Purpose: 
//-----------------------------------------------------------------------------
void CBulletAR2::BulletThink( void )
{
	QAngle angNewAngles;
