...
IMPLEMENT_NETWORKCLASS_ALIASED( WeaponGaussHD, DT_WeaponGaussHD );

BEGIN_NETWORK_TABLE( CWeaponGaussHD, DT_WeaponGaussHD )
#ifdef CLIENT_DLL
...
BEGIN_PREDICTION_DATA( CWeaponGaussHD )
#ifdef CLIENT_DLL
...
//LINK_ENTITY_TO_CLASS( weapon_gauss, CWeaponGaussHD );
//PRECACHE_WEAPON_REGISTER( weapon_gauss );

//IMPLEMENT_SERVERCLASS_ST( CWeaponGaussHD, DT_WeaponGaussHD )
//END_SEND_TABLE()

BEGIN_DATADESC( CWeaponGaussHD )
...
// Purpose: Constructor
//-----------------------------------------------------------------------------
CWeaponGaussHD::CWeaponGaussHD( void )
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CWeaponGaussHD::Precache( void )
{
...
float CWeaponGaussHD::GetFullChargeTime( void )
{
	return 4;
}
...
// Purpose:
//-----------------------------------------------------------------------------
void CWeaponGaussHD::PrimaryAttack( void )
{
...
// Purpose:
//-----------------------------------------------------------------------------
void CWeaponGaussHD::SecondaryAttack( void )
{
#ifdef CLIENT_DLL
...
//=========================================================
void CWeaponGaussHD::StartFire( void )
{
	float flDamage;
...
void CWeaponGaussHD::Fire( Vector vecOrigSrc, Vector vecDir, float flDamage )
{
	CBaseEntity *pIgnore;
...
void CWeaponGaussHD::WeaponIdle( void )
{
	//SMOD: Ironsight fix
	if (m_bIsIronsighted)
		return;
...
void CWeaponGaussHD::AddViewKick( void )
{
}

bool CWeaponGaussHD::Deploy( void )
{
...
bool CWeaponGaussHD::Holster( CBaseCombatWeapon *pSwitchingTo )
{
...
void CWeaponGaussHD::StopSpinSound( void )
{
	if ( m_sndCharge != NULL )
	{
