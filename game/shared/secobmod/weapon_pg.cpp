...
#if 1 //#ifdef SecobMod__ENABLE_IN_TESTING_ITEMS
...
EmitSound( "Weapon_Portalgun.fire_blue" );
	...
	CPortalBolt *pBolt = CPortalBolt::BoltCreate( vecSrc, angAiming, 0, pOwner );
...
EmitSound( "Weapon_Portalgun.fire_red" );
	...
	CPortalBolt *pBolt2 = CPortalBolt::BoltCreate2( vecSrc, angAiming, 0, pOwner );
