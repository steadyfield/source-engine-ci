...
Activity ACT_STRIKER_JUMP;
Activity ACT_STRIKER_LAND;
Activity ACT_STRIKER_GLIDE;
// -----------------------------------------------
//	> Squad slots
// -----------------------------------------------
enum SquadSlot_T
...
void CNPC_Combine::StartTask(const Task_t *pTask)
{
	...
	break;
	case TASK_COMBINE_MOVE_TO_GRENADE_POSITION:
	{
		CBaseEntity *pEnemy = GetEnemy();
	...
	case TASK_COMBINE_FIND_SPREAD_POSITION:
	{
		if (GetEnemy() == NULL)
		{
		...
		if (!HasCondition(COND_SEE_ENEMY) && OccupyStrategySlot(SQUAD_SLOT_GRENADE1) && !IsElite())
			{
				...
				{
					return SCHED_COMBINE_MOVE_TO_GRENADE_POSITION;
				}
				/**/
				...
				if (HasCondition(COND_WEAPON_HAS_LOS) && IsStrategySlotRangeOccupied(SQUAD_SLOT_ATTACK1, SQUAD_SLOT_ATTACK3))
				{
					...
					// If everyone else is attacking and I have line of fire, flank or wait for a chance to cover someone.
						...
						if (OccupyStrategySlotRange(SQUAD_SLOT_COMBINE_FLANK_FIRST, SQUAD_SLOT_COMBINE_FLANK_LAST))
						{
							...
							return	SCHED_COMBINE_TAKE_SPREAD_COVER;
						}
						else
			...
			else
			{
				...
				if (!bFirstContact && OccupyStrategySlotRange(SQUAD_SLOT_ATTACK1, SQUAD_SLOT_ATTACK2))
				{
					...
					else
					{
						...
						return SCHED_COMBINE_SPREAD_OUT;
					}
					/**/
				}
...
int CNPC_Combine::TranslateSchedule(int scheduleType)
{
	...
	case SCHED_COMBINE_TAKE_COVER2:
	{
	...
	case SCHED_FAIL_ESTABLISH_LINE_OF_FIRE:
	{
		...
		{
			return TranslateSchedule(SCHED_COMBINE_MOVE_TO_GRENADE_POSITION);
		}
		/**/
	...
	case SCHED_COMBINE_MOVE_TO_GRENADE_POSITION:
	{
...
#define MIN_SIGNAL_DIST	256
	...
	case SCHED_COMBINE_OVERWATCH:
	{
		...
		return SCHED_COMBINE_OVERWATCH;
	}
	break;
...
DECLARE_TASK(TASK_COMBINE_MOVE_TO_GRENADE_POSITION)
DECLARE_TASK(TASK_COMBINE_FIND_SPREAD_POSITION)
...
"		TASK_SET_SCHEDULE				SCHEDULE:SCHED_COMBINE_FLINCH_END"
...
//"		TASK_SET_SCHEDULE						SCHEDULE:SCHED_COMBINE_SPREAD_OUT"
""
"	Interrupts"
)
...
"		TASK_WAIT_FOR_MOVEMENT		0"
"		TASK_REMEMBER				MEMORY:INCOVER"
"		TASK_SET_SCHEDULE			SCHEDULE:SCHED_COMBINE_WAIT_IN_COVER2"
""
"	Interrupts"
//"		COND_HEAR_DANGER"
)
...
"	Tasks"
//"		TASK_SET_FAIL_SCHEDULE		SCHEDULE:SCHED_COMBINE_SPREAD_OUT"
"		TASK_SET_FAIL_SCHEDULE		SCHEDULE:SCHED_COMBINE_TAKECOVER_FAILED"
"		TASK_STOP_MOVING				0"
"		TASK_WAIT					0.2"
...
"		TASK_WAIT					0.2"
"		TASK_REMEMBER				MEMORY:INCOVER"
"		TASK_SET_SCHEDULE						SCHEDULE:SCHED_COMBINE_FLANK_ENEMY"
//"		TASK_SET_SCHEDULE						SCHEDULE:SCHED_COMBINE_SPREAD_OUT"
""
"	Interrupts"
)
...
"		TASK_COMBINE_FIND_SPREAD_POSITION		0"
...
"		TASK_COMBINE_MOVE_TO_GRENADE_POSITION	0"
"		TASK_SPEAK_SENTENCE							1"
"		TASK_RUN_PATH								0"
"		TASK_WAIT_FOR_MOVEMENT						0"
"	"
