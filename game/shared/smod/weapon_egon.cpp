...
IMPLEMENT_NETWORKCLASS_ALIASED( WeaponEgonHD, DT_WeaponEgonHD );

BEGIN_NETWORK_TABLE( CWeaponEgonHD, DT_WeaponEgonHD )
END_NETWORK_TABLE()    

BEGIN_PREDICTION_DATA( CWeaponEgonHD )
END_PREDICTION_DATA()

//LINK_ENTITY_TO_CLASS( weapon_egon, CWeaponEgonHD );
//PRECACHE_WEAPON_REGISTER( weapon_egon );

/*
IMPLEMENT_SERVERCLASS_ST( CWeaponEgonHD, DT_WeaponEgonHD )
END_SEND_TABLE()
*/

    /*
BEGIN_DATADESC( CWeaponEgonHD )
...
// Purpose: Constructor
//-----------------------------------------------------------------------------
CWeaponEgonHD::CWeaponEgonHD( void )
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CWeaponEgonHD::Precache( void )
{
...
bool CWeaponEgonHD::Deploy( void )
{
...
bool CWeaponEgonHD::HasAmmo( void )
{
#ifdef CLIENT_DLL
...
void CWeaponEgonHD::UseAmmo( int count )
{
#ifdef CLIENT_DLL
	C_BaseHLPlayer *pPlayer;
#else
...
// Purpose:
//-----------------------------------------------------------------------------
void CWeaponEgonHD::PrimaryAttack( void )
{
#ifdef CLIENT_DLL
	C_BaseHLPlayer *pPlayer;
#else
...
void CWeaponEgonHD::Fire( const Vector &vecOrigSrc, const Vector &vecDir )
{
#ifdef CLIENT_DLL
	C_BaseHLPlayer *pPlayer;
#else
...
void CWeaponEgonHD::UpdateEffect( const Vector &startPoint, const Vector &endPoint )
{
	if ( !m_hBeam )
	{
		CreateEffect();
...
void CWeaponEgonHD::CreateEffect( void )
{
#ifndef CLIENT_DLL    
...
void CWeaponEgonHD::DestroyEffect( void )
{
#ifndef CLIENT_DLL    
	if ( m_hBeam )
	{
...
void CWeaponEgonHD::EndAttack( void )
{
...
bool CWeaponEgonHD::Holster( CBaseCombatWeapon *pSwitchingTo )
{
    EndAttack();
...
void CWeaponEgonHD::WeaponIdle( void )
{
	//SMOD: Ironsight fix
	if (m_bIsIronsighted)
		return;
