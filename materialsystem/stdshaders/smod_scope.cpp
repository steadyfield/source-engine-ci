...
BEGIN_VS_SHADER(smod_scope, "Help for Refract")
...
void SetupVars(smod_scope_Vars_t& info)
{
...
SHADER_INIT_PARAMS()
{
	...
	SetupVars(info);
	InitParamssmod_scope(this, params, pMaterialName, info);
}
...
SHADER_INIT
{
	smod_scope_Vars_t info;
	SetupVars(info);
	Initsmod_scope(this, params, info);
}
...
SHADER_DRAW
{
	...
	{
		Drawsmod_scope(this, params, pShaderAPI, pShaderShadow, info, vertexCompression);
	}
	else
	{
		Draw(false);
