...
class CWeaponGrease : public CHLSelectFireMachineGun
{
	DECLARE_DATADESC();
public:
	DECLARE_CLASS(CWeaponGrease, CHLSelectFireMachineGun);
	...
	float	GetFireRate(void) { return 0.17f; }	// 13.3hz
...
IMPLEMENT_SERVERCLASS_ST(CWeaponGrease, DT_WeaponGrease)
END_SEND_TABLE()

LINK_ENTITY_TO_CLASS(weapon_grease, CWeaponGrease);
PRECACHE_WEAPON_REGISTER(weapon_grease);

BEGIN_DATADESC(CWeaponGrease)
...
acttable_t	CWeaponGrease::m_acttable[] =
{
...
IMPLEMENT_ACTTABLE(CWeaponGrease);

//=========================================================
CWeaponGrease::CWeaponGrease()
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CWeaponGrease::Precache(void)
{
...
//
//-----------------------------------------------------------------------------
void CWeaponGrease::Fire9MMBullet( void )
{
...
//-----------------------------------------------------------------------------
void CWeaponGrease::Equip(CBaseCombatCharacter *pOwner)
{
...
//
//-----------------------------------------------------------------------------
void CWeaponGrease::PrimaryAttack( void )
{
...
void CWeaponGrease::FireNPC9MMBullet( void )
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CWeaponGrease::FireNPCPrimaryAttack(CBaseCombatCharacter *pOperator, Vector &vecShootOrigin, Vector &vecShootDir)
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CWeaponGrease::Operator_ForceNPCFire(CBaseCombatCharacter *pOperator, bool bSecondary)
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CWeaponGrease::Operator_HandleAnimEvent(animevent_t *pEvent, CBaseCombatCharacter *pOperator)
{
	CHL2_Player *pPlayer = dynamic_cast < CHL2_Player* >(UTIL_PlayerByIndex(1));
...
// Output : Activity
//-----------------------------------------------------------------------------
Activity CWeaponGrease::GetPrimaryAttackActivity(void)
{
	if (m_nShotsFired < 2)
...
//-----------------------------------------------------------------------------
//-----------------------------------------------------------------------------
bool CWeaponGrease::Reload(void)
{
	bool fRet;
...
// Purpose: 
//-----------------------------------------------------------------------------
void CWeaponGrease::AddViewKick(void)
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CWeaponGrease::SecondaryAttack(void)
{
}
...
// Output : int
//-----------------------------------------------------------------------------
int CWeaponGrease::WeaponRangeAttack2Condition(float flDot, float flDist)
{
...
//-----------------------------------------------------------------------------
const WeaponProficiencyInfo_t *CWeaponGrease::GetProficiencyValues()
{
