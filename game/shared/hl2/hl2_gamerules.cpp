...
CAmmoDef *GetAmmoDef()
{
	...
	if ( !bInitted )
	{
		...
		def.AddAmmoType("TripMine",			DMG_BLAST,					TRACER_NONE, 			"sk_plr_dmg_tripmine",		"sk_npc_dmg_tripmine",		"sk_max_tripmine",		0, 0 );
		...
		def.AddAmmoType("LargeRound",		DMG_BULLET,					TRACER_LINE, 			"sk_plr_dmg_large_round",	"sk_npc_dmg_large_round",	"sk_max_large_round",	BULLET_IMPULSE(300, 1225), 0 );
