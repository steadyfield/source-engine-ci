//========= Copyright ? 1996-2008, Duffman?, Wargon, Valve Corporation, All rights reserved. ============//
//
//						#Public code#
//Author: Wargon, Duffman?
//
// Legendary Physgun now working properly in release
//========================================================================================================//
...
public:
	...
	void Precache()
	{
		SetModelName( MAKE_STRING( "models/weapons/glue.mdl" ) ); //???? ?? ????
