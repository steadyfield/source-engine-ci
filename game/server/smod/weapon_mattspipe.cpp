...
//
// Purpose:		MattsPipe - Citizen Matt's own special pipe weapon.  
//				What a lucky boy, he gets his own personal weapon!
//
//=============================================================================//
...
//-----------------------------------------------------------------------------
// Attempt to lead the target (needed because citizens can't hit manhacks with the MattsPipe!)
//-----------------------------------------------------------------------------
...
void CMattsPipe::HandleAnimEventMeleeHit( animevent_t *pEvent, CBaseCombatCharacter *pOperator )
{
	...
	CBaseEntity *pHurt = pOperator->CheckTraceHullAttack( pOperator->Weapon_ShootPosition(), vecEnd, 
		Vector(-16,-16,-16), Vector(36,36,36), sk_npc_dmg_MattsPipe.GetFloat(), DMG_CLUB, 0.75 );
