...
void DOD_EjectBrassCallback( const CEffectData &data )
{
	...
	pTemp->SetCollisionGroup( COLLISION_GROUP_DEBRIS ); //SMOD: Should be it's own group by default but because HL2 lacks it lets just give it the same group as gibs
}
