...
//SMOD: We'll just put these here to be able to use CStrike's better shell edjection methods with HL2's shells
void SMOD_FX_EdjectBrass_Pistol_Callback(const CEffectData &data)
{
	CStrike_EjectBrass(HL2_SHELL_PISTOL, data);
}

void SMOD_FX_EdjectBrass_Rifle_Callback(const CEffectData &data)
{
	CStrike_EjectBrass(HL2_SHELL_RIFLE, data);
}

void SMOD_FX_EdjectBrass_Shotgun_Callback(const CEffectData &data)
{
	CStrike_EjectBrass(HL2_SHELL_SHOTGUN, data);
}

DECLARE_CLIENT_EFFECT( "EjectBrass_HL2Pistol",		SMOD_FX_EdjectBrass_Pistol_Callback );
DECLARE_CLIENT_EFFECT( "EjectBrass_HL2Rifle",		SMOD_FX_EdjectBrass_Rifle_Callback );
DECLARE_CLIENT_EFFECT( "EjectBrass_HL2Shotgun",		SMOD_FX_EdjectBrass_Shotgun_Callback );
